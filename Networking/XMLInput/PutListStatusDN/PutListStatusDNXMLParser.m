...
@interface PutListStatusDNXMLParser () <NSXMLParserDelegate>
...
@implementation PutListStatusDNXMLParser
...
- (void)updateDN {
    if (sqlite3_open(SQLWorker.dbPath.UTF8String, &database) == SQLITE_OK) {
        ...
        const char *sql = "update DNTable set SendStatus = ? where CustAccount = ? and (SendStatus = 'Error' or SendStatus = 'Modified')";
