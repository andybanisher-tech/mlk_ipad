//
//  PutGroupPropertiesValueRequest.m
//  MLK
//
...
#import "PutGroupPropertiesValueXMLParser.h"
#import "XMLWriter.h"
...
@interface PutGroupPropertiesValueRequest ()
@property (nonatomic, strong) NSProgress *progress;

@end

@implementation PutGroupPropertiesValueRequest
...
- (void)handleSuccess:(NSData *)data {
    ...
    PutGroupPropertiesValueXMLParser *parser = [PutGroupPropertiesValueXMLParser new];
    parser.custAccount = custAccount;
    [parser parse:data];
    
    PutPhotosRequest *putGroupPhotos = [PutPhotosRequest new];
    putGroupPhotos.custAccount = custAccount;
    putGroupPhotos.notShowProgress = notShowProgress;
    [putGroupPhotos sendGroupPhotos];
}
