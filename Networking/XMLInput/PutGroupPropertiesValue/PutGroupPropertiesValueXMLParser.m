//
//  PutGroupPropertiesValueXMLParser.m
//  MLK
//
...
@interface PutGroupPropertiesValueXMLParser () <NSXMLParserDelegate>
...
@implementation PutGroupPropertiesValueXMLParser
...
- (void)updateGP {
    ...
    if (sqlite3_open(SQLWorker.dbPath.UTF8String, &database) == SQLITE_OK) {
        ...
        const char *sql = "update PropertiesValue set SendStatus = ? where Date = ? and CustAccount = ? and (SendStatus = 'Error' or SendStatus = 'New')";
...
- (void)parserDidEndDocument:(NSXMLParser *)parser {
    ...
    [NSNotificationCenter.defaultCenter postNotificationName:@"custPPReloadTable" object:nil];
}
