//
//  PutTTPropertiesValueXMLParser.m
//  MLK
//
...
@interface PutTTPropertiesValueXMLParser () <NSXMLParserDelegate>
...
@implementation PutTTPropertiesValueXMLParser
...
//    NSString *strDate = [dateFormatter stringFromDate:date];
    ...
    if (sqlite3_open(SQLWorker.dbPath.UTF8String, &database) == SQLITE_OK) {
        ...
        //const char *sql = "update TTPropertiesValue set SendStatus = ? where Date = ? and CustAccount = ? and (SendStatus = 'Error' or SendStatus = 'New')";
        const char *sql = "update TTPropertiesValue set SendStatus = ? where CustAccount = ? and (SendStatus = 'Error' or SendStatus = 'New')";
